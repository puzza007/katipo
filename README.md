...
| `http_version`          | `curl_http_version_none` <br> `curl_http_version_1_0` <br> `curl_http_version_1_1` <br> `curl_http_version_2_0` <br> `curl_http_version_2tls` <br> `curl_http_version_2_prior_knowledge` | `curl_http_version_none` | [docs](https://curl.se/libcurl/c/CURLOPT_HTTP_VERSION.html) curl >= 7.62.0 |
...
| `lock_data_ssl_session` | `bool()`                                | `true`       | [docs](https://curl.se/libcurl/c/CURLSHOPT_SHARE.html)                                    |
| `lock_data_dns`         | `bool()`                                | `true`       | [docs](https://curl.se/libcurl/c/CURLSHOPT_SHARE.html)                                    |
| `lock_data_connect`     | `bool()`                                | `true`       | [docs](https://curl.se/libcurl/c/CURLSHOPT_SHARE.html)                                    |
